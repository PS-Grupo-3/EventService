...
public interface IEventQuery
{
    ...
    Task<IEnumerable<Event>> GetFilteredAsync(Guid? eventId, int? categoryId, int? statusId, DateTime? from, DateTime? to, string? Name, CancellationToken cancellationToken = default);
